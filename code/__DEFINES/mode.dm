...
GLOBAL_LIST_INIT(ROLES_AI_CONTAINMENT, list(JOB_CONTAINMENT_SO, JOB_CONTAINMENT_IO, JOB_SQUAD_LEADER_FORECON, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN_FORECON, JOB_SQUAD_MEDIC_FORECON, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE_FORECON))
