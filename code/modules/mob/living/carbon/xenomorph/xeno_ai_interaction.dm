...
/obj/structure/window/framed/xeno_ai_obstacle(mob/living/carbon/xenomorph/X, direction, turf/target)
	if(X.claw_type == CLAW_TYPE_VERY_SHARP || X.claw_type >= CLAW_TYPE_SHARP)
